/*!
 * react-page-scroller v1.2.0 - https://vikliegostaiev.github.io/react-page-scroller/
 * MIT Licensed
 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(131);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_polyfill__ = __webpack_require__(132);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_prop_types__ = __webpack_require__(334);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_lodash__ = __webpack_require__(338);
...
var ReactPageScroller = function (_React$Component) {
    ...
    function ReactPageScroller(props) {
        ...
        _this.componentDidMount = function () {
            ...
            if (!__WEBPACK_IMPORTED_MODULE_3_lodash___default.a.isNil(_this.props.children[_this.state.componentIndex])) {
                componentsToRender.push(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    "div",
        ...
        _this.addNextComponent = function (onMountedComponents) {
            ...
            if (!__WEBPACK_IMPORTED_MODULE_3_lodash___default.a.isNil(onMountedComponents)) {
            ...
            if (!componentsToRender[_this.state.componentIndex + 1]) {
                if (!__WEBPACK_IMPORTED_MODULE_3_lodash___default.a.isNil(_this.props.children[_this.state.componentIndex + 1])) {
                    componentsToRender.push(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        "div",
        ...
        _this.touchMove = function (event) {
            ...
            if (!__WEBPACK_IMPORTED_MODULE_3_lodash___default.a.isNull(_this[previousTouchMove])) {
        ...
        _this.keyPress = function (event) {
            ...
            if (__WEBPACK_IMPORTED_MODULE_3_lodash___default.a.isEqual(event.keyCode, 38)) {
                _this.scrollWindowUp();
            }
            if (__WEBPACK_IMPORTED_MODULE_3_lodash___default.a.isEqual(event.keyCode, 40)) {
                _this.scrollWindowDown();
            }
        };
        ...
        _this.scrollWindowUp = function () {
            ...
            if (!__WEBPACK_IMPORTED_MODULE_3_lodash___default.a.isNil(_this["container_" + (_this.state.componentIndex - 1)]) && !_this[scrolling]) {
        ...
        _this.goToPage = function (number) {
            if (!__WEBPACK_IMPORTED_MODULE_3_lodash___default.a.isEqual(_this.state.componentIndex, number)) {
                if (!__WEBPACK_IMPORTED_MODULE_3_lodash___default.a.isNil(_this["container_" + number]) && !_this[scrolling]) {
                    ...
                    if (__WEBPACK_IMPORTED_MODULE_3_lodash___default.a.isNil(_this["container_" + number])) _this.state.componentsToRender.push(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        "div",
                        { key: number + 1,
                            ref: function ref(c) {
                ...
                } else if (!_this[scrolling] && !__WEBPACK_IMPORTED_MODULE_3_lodash___default.a.isNil(_this.props.children[number])) {

                    var componentsLength = _this.state.componentsToRender.length;

                    var _loop = function _loop(i) {
                        _this.state.componentsToRender.push(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            "div",
                            { key: i + 1,
                                ref: function ref(c) {
    ...
    _createClass(ReactPageScroller, null, [{
        ...
        get: function get() {
            return {
                animationTimer: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.number,
                transitionTimingFunction: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.string,
                pageOnChange: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.func,
                scrollUnavailable: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.func
            };
        }
    }, {
        key: "defaultProps",
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(63), __webpack_require__(339)(module)))
