...
var ReactPageScroller = function (_React$Component) {
    ...
    function ReactPageScroller(props) {
        ...
        _this.goToPage = function (number) {
            if (!_.isEqual(_this.state.componentIndex, number)) {
                if (!_.isNil(_this["container_" + number]) && !_this[scrolling]) {
                    ...
                    if (_.isNil(_this["container_" + number])) _this.state.componentsToRender.push(React.createElement(
                        "div",
                        { key: number + 1,
                            ref: function ref(c) {
                ...
                } else if (!_this[scrolling] && !_.isNil(_this.props.children[number])) {

                    var componentsLength = _this.state.componentsToRender.length;

                    var _loop = function _loop(i) {
                        _this.state.componentsToRender.push(React.createElement(
                            "div",
                            { key: i + 1,
                                ref: function ref(c) {
